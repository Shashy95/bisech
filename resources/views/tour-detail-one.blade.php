<!-- resources/views/tour-detail-one.blade.php -->
@extends('layouts.main')

@section('title', 'Tour-Detail-One Page')
                ...
                <div class="grid grid-cols-12 gap-4">
                    <div class="md:col-span-8 col-span-7">
                        <div class="group relative overflow-hidden rounded shadow-sm dark:shadow-gray-800">
                            <img src="{{ !empty($item['img']) ? asset($item['img']) : asset('assets/images/listing/1.jpg') }}" class="w-full lg:h-60 md:h-44 h-48 object-cover" alt="">
                            ...
                            <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center opacity-0 group-hover:opacity-100 duration-500">
                                <a href="{{ !empty($item['img']) ? asset($item['img']) : asset('assets/images/listing/1.jpg') }}" class="inline-flex justify-center items-center size-9 bg-red-500 text-white rounded-full lightbox"><i data-feather="camera" class="size-4 align-middle"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-4 col-span-5">
                        <div class="group relative overflow-hidden rounded shadow-sm dark:shadow-gray-800">
                            <img src="{{ asset('assets/images/listing/2.jpg') }}" class="w-full lg:h-60 md:h-44 h-48 object-cover" alt="">
                            <div class="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out"></div>
                            <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center opacity-0 group-hover:opacity-100 duration-500">
                                <a href="{{ asset('assets/images/listing/2.jpg') }}" class="inline-flex justify-center items-center size-9 bg-red-500 text-white rounded-full lightbox"><i data-feather="camera" class="size-4 align-middle"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-4 col-span-5">
                        <div class="group relative overflow-hidden rounded shadow-sm dark:shadow-gray-800">
                            <img src="{{ asset('assets/images/listing/3.jpg') }}" class="w-full lg:h-60 md:h-44 h-48 object-cover" alt="">
                            <div class="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out"></div>
                            <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center opacity-0 group-hover:opacity-100 duration-500">
                                <a href="{{ asset('assets/images/listing/3.jpg') }}" class="inline-flex justify-center items-center size-9 bg-red-500 text-white rounded-full lightbox"><i data-feather="camera" class="size-4 align-middle"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-8 col-span-7">
                        <div class="group relative overflow-hidden rounded shadow-sm dark:shadow-gray-800">
                            <img src="{{ asset('assets/images/listing/4.jpg') }}" class="w-full lg:h-60 md:h-44 h-48 object-cover" alt="">
                            <div class="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out"></div>
                            <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center opacity-0 group-hover:opacity-100 duration-500">
                                <a href="{{ asset('assets/images/listing/4.jpg') }}" class="inline-flex justify-center items-center size-9 bg-red-500 text-white rounded-full lightbox"><i data-feather="camera" class="size-4 align-middle"></i></a>
                            </div>
                        </div>
                    </div>
                </div>

                <h5 class="text-2xl font-semibold mt-5">New Zealand’s South Island brims with majestic</h5>
