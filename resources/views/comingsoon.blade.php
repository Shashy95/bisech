...
<!-- Start -->
<section class="relative bg-no-repeat bg-center bg-cover" style="background-image: url('{{ asset('assets/images/bg/cta.jpg') }}');">
                ...
                <div class="title-heading text-center my-auto">
                    ...
                    <div id="countdown">
                        <ul class="count-down list-none inline-block text-white text-center mt-8 m-6">
                            <li id="days" class="text-[40px] leading-[110px] h-[130px] w-[130px] rounded-full shadow-md bg-white/20 backdrop-opacity-30 inline-block m-2"></li>
                            <li id="hours" class="text-[40px] leading-[110px] h-[130px] w-[130px] rounded-full shadow-md bg-white/20 backdrop-opacity-30 inline-block m-2"></li>
                            <li id="mins" class="text-[40px] leading-[110px] h-[130px] w-[130px] rounded-full shadow-md bg-white/20 backdrop-opacity-30 inline-block m-2"></li>
                            <li id="secs" class="text-[40px] leading-[110px] h-[130px] w-[130px] rounded-full shadow-md bg-white/20 backdrop-opacity-30 inline-block m-2"></li>
