...
<nav id="topnav" class="defaultscroll is-sticky">
    <div class="container relative">
        ...
        <a class="logo" href="{{ url('/') }}">
            <div>
                <img src="{{ asset('assets/images/logo-dark.png') }}" class="h-7 inline-block dark:hidden" alt="">
                <img src="{{ asset('assets/images/logo-white.png') }}" class="h-7 hidden dark:inline-block" alt="">
            </div>
        </a>
        <!-- End Logo container-->
