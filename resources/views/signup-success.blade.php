...
@section('title', 'Signup-Success Page')
            ...
            <div class="lg:w-2/5">
                <div class="relative overflow-hidden rounded-md bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800">
                    ...
                    <div class="px-6 py-12 text-center">
                        ...
                        <div class="mt-6">
                            <a href="{{ url('/') }}" class="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-red-500 text-white rounded-md">Continue</a>
                        </div>
                    </div>
